    ...
    <div class="row no-gutters">
        <div class="col-md-0 bg-info pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="../View/tampilorder.php"><i class="fas fa-file-contract mr-2"></i>Daftar Pemesanan Kos</a>
                    <hr class="bg-warning">
                </li>
            </ul>
        </div>
        <div class="col-md-10 p-5 ">
            <h3><i class="fas fa-igloo mr-2"></i>Daftar Pasar Buah </h3>
            <hr>
<?php
...
$db = new database ();
?>
<a href ="../View/inputBuah.php">Tambah Data Buah</a>
<table border="1">
<tr>
<th>No</th>
<th>Id Buah</th>
<th>Nama Buah</th>
<th>Harga Buah Kos</th>
<th>Keterangan</th>
</tr>
...
<tr>
<td><?php echo $no++; ?></td>
<td><?php echo $x['nama_buah']; ?></td>
<td><?php echo $x['harga_buah']; ?></td>
<td><?php echo $x['keterangan']; ?></td>
<td>
<a href="../View/editBuah.php?id_kos=<?php echo $x['id_buah']; ?>&aksi=edit">Edit Data</a>
<a href="../Controller/prosesBuah.php?id_kos=<?php echo $x['id_buah']; ?>&aksi=hapus">Hapus Data</a>
</td>
</tr>
<?php
}
